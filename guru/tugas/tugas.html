        ...
        <div class="content w-100">
                ...
                <div class="container mt-1">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h3>Control panel</h3>
                        <button class="btn btn-success"><a href="tambah-tugas.html" class="text-reset">Tambah Tugas +</a></button>
                    </div>
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td>Tugas Ringkasan Materi MTK 1</td>
                                <td>Membuat Ringkasan Materi MTK pada Pertemuan 1</td>
                                <td>VII A</td>
                                <td>1 Hari</td>
                                <td>Rudi, A.Md.</td>
                                <td>2018-02-01</td>
                                <td>Paling Lambat Upload Tugas hari ini</td>
                                <td>Aktif</td>
                                <td>Sudah Dikirim</td>
                                <td>Matematika</td>
                                <td>
                                    <a href=""><button class="btn btn-primary btn-sm" >Detail</button></a>
                                    <a href="edittugas.html"><button class="btn btn-warning btn-sm">Edit</button></a>
                                    <button class="btn btn-danger btn-sm">Delete</button>
                                </td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td>Tugas Mandiri MTK 1</td>
                                <td>Membuat Soal dan Jawaban sendiri untuk Materi Persamaan Linier dan Kuadrat</td>
                                <td>IX A</td>
                                <td>2 Hari</td>
                                <td>Rudi, A.Md.</td>
                                <td>2018-02-28</td>
                                <td>Tulis tangan lalu di simpan dalam file .pdf atau .doc lalu di upload</td>
                                <td>Aktif</td>
                                <td>Belum Dikirim</td>
                                <td>Matematika</td>
                                <td>
                                    <a href="detail-tugas.html"><button class="btn btn-primary btn-sm">Detail</button></a>
                                    <a href="edittugas.html"><button class="btn btn-warning btn-sm">Edit</button></a>
                                    <button class="btn btn-danger btn-sm">Delete</button>
                                </td>
                            </tr>
