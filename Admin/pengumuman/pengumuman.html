    ...
    <div class="d-flex">
        ...
        <div class="container mt-5">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1>Pengumuman</h1>
                <a href="Tambahguru"><button type="#" class="btn btn-success" >Tambahkan +</button></a>
            </div>
            <table class="table table-bordered">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th>Tanggal Mulai dan Tanggal Akhir</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut, corporis.</td>
                        <td>18/06/06</td>
                        <td>18/06/07 - 18/06/18</td>
                        <td>Pendidikan</td>
                        <td>
                            <a href="detailpengumuman.html"><button class="btn btn-primary btn-sm">Detail</button></a>
                            <a href="editpengumuman.html"><button class="btn btn-warning btn-sm">Edit</button></a>
