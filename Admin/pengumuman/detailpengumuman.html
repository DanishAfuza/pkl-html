        ...
        <div class="container mt-5">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form>
                        <div class="mb-3">
                            <label for="namalengkap" class="form-label">Judul Pengumuman</label>
                            <input type="text" class="form-control" id="nomor" value="" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="nip" class="form-label">Isi Pengumuman</label>
                            <input type="text" class="form-control" id="nis" value="" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="nama" class="form-label">Tanggal Pengumuman</label>
                            <input type="text" class="form-control" id="nama" value="" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="kelas" class="form-label">Tanggal Mulai</label>
                            <input type="text" class="form-control" id="kelas" value="" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="alamat" class="form-label">Tanggal Akhir</label>
                            <input type="text" class="form-control" id="alamat" value="" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="keterangan" class="form-label">Kategori Pengumuman</label>
                            <input type="text" class="form-control" id="alamat" value="" disabled>
                        </div>
